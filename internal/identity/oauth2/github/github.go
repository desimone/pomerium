// Package github implements OpenID Connect for github
//
...
var _ identity.Authenticator = &GitHubProvider{}
...
func New(ctx context.Context, o *identity.Options) (*GitHubProvider, error) {
	...
	p.Oauth = &oauth2.Config{
		...
		Endpoint: oauth2.Endpoint{
			AuthURL:  o.ProviderURL + "/login/oauth/authorize",
			TokenURL: o.ProviderURL + "/login/oauth/access_token",
		},
