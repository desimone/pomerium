...
const defaultProviderURL = "https://accounts.google.com"

var defaultScopes = []string{oidc.ScopeOpenID, "profile", "email"}

// GoogleProvider is a Google implementation of the Authenticator interface.
...
func New(ctx context.Context, o *identity.Options) (*GoogleProvider, error) {
