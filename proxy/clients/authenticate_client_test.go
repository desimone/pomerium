...
func TestNewGRPC(t *testing.T) {
	tests := []struct {
		...
		{"empty connection", &Options{Addr: url.URL{}, SharedSecret: "shh"}, true, "proxy/authenticator: connection address required", ""},
		{"both internal and addr empty", &Options{Addr: url.URL{}, InternalAddr: url.URL{}, SharedSecret: "shh"}, true, "proxy/authenticator: connection address required", ""},
